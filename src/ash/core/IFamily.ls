package ash.core
{
	...
	{
		function init( nodeClass : Type, engine : Engine ) : void;
		 ...
		 */
		function componentAddedToEntity( entity : Entity, componentClass : Type ) : void;
		/**
		 * A component has been removed from an entity. Test whether the entity's inclusion in this family's
		 * NodeList should be modified.
		 */
		function componentRemovedFromEntity( entity : Entity, componentClass : Type ) : void;
		/**
