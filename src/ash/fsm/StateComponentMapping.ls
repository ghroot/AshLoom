package ash.fsm
{
	...
	public class StateComponentMapping
	{
		 ...
		 */
		public function StateComponentMapping( creatingState : EntityState, type : Type )
		{
		 ...
		 */
		public function withInstance( component : Object ) : StateComponentMapping
		{
		 ...
		 * @return This ComponentMapping, so more modifications can be applied
		 */
		public function withType( type : Type ) : StateComponentMapping
		{
         ...
         * @return This ComponentMapping, so more modifications can be applied
         */
        public function withSingleton( type : Type = null ) : StateComponentMapping
        {
            if( !type )
            {
                type = componentType;
