package ash.fsm
{
	...
	{
		public var providers : Vector.<ISystemProvider> = new Vector.<ISystemProvider>();
		 ...
		 * @return This StateSystemMapping, so more modifications can be applied
		 */
		public function addSingleton( type : Type ) : StateSystemMapping
		{
